  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4">
      ...
      <div className="relative z-10 text-center flex flex-col items-center gap-6 max-w-md">
        <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-[#6366f1]/10 border border-[#6366f1]/20">
          <BarChart3 className="w-7 h-7 text-[#6366f1]" />
        </div>

        <div>
          <p className="text-8xl font-black text-[#1e1e2e] select-none">404</p>
